...
public class RouteListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<String>(getActivity(),
				...
				android.R.id.text1, ((GreekTours) getActivity().getApplication()).getAllRouteNames()));
	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(((GreekTours) getActivity().getApplication()).getAllRouteNames().get(position));
	}
